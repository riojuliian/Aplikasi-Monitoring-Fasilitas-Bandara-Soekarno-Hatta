...
public class PerbaikanActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseRef.child("before").child(terminallogin).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                mAdapter = new ImageAdapter(PerbaikanActivity2.this, mUploads);
            ...
            public void onCancelled(DatabaseError databaseError) {
                Toast.makeText(PerbaikanActivity2.this, databaseError.getMessage(), Toast.LENGTH_SHORT).show();
                mProgressCircle.setVisibility(View.INVISIBLE);
            }
        });
        mDatabaseRef.child(terminallogin).addChildEventListener(new ChildEventListener() {
            @Override
